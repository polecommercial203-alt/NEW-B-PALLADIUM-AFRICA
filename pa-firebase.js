...
function loginScreen() {
  ...
  wrap.innerHTML = `
    <form style="background:#fff;border-radius:14px;padding:34px 30px;width:min(100%,380px);
                 box-shadow:0 20px 60px rgba(0,0,0,.4)">
      <h1 style="margin:0 0 4px;font-size:21px;color:#12232b">Palladium Africa</h1>
      <p style="margin:0 0 22px;color:#66787f;font-size:13.5px">CRM de pilotage commercial</p>
